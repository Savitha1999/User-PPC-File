...
//                   <div key={property._id} className="card mb-3 shadow p-1" style={{ width: "100%", minWidth: "400px", background: "#F9F9F9" }}>
...
//                             <FaCamera className="me-1" /> {property.photos.length}
//                           </span>
...
//                               <span style={{ fontSize: "14px", color: "#555555" }}>{property.totalArea}</span>
//                             </div>
//                             <div className="col-6 d-flex align-items-center mt-1 mb-1">
//                               <FaBed className="me-2" color="#2F747F" />{" "}
//                               <span style={{ fontSize: "14px", color: "#555555" }}>{property.bedrooms || "N/A"}</span>
//                             </div>
//                             <div className="col-6 d-flex align-items-center mt-1 mb-1">
//                               <FaUserAlt className="me-2" color="#2F747F" />{" "}
//                               <span style={{ fontSize: "14px", color: "#555555" }}>{property.ownership}</span>
//                             </div>
//                             <div className="col-6 d-flex align-items-center mt-1 mb-1">
//                               <FaCalendarAlt className="me-2" color="#2F747F" />{" "}
//                               <span style={{ fontSize: "14px", color: "#555555" }}>{property.bestTimeToCall}</span>
//                             </div>
//                             <div className="col-6 d-flex align-items-center mt-1 mb-1">
//                               <FaRupeeSign className="me-2" color="#2F747F" />{" "}
//                               <span style={{ fontSize: "14px", color: "#555555" }}>{property.price}</span>
//                             </div>
//                             <div className="col-6 d-flex align-items-center mt-1 mb-1">
