...
//       try {
//         const response = await axios.get(`${process.env.REACT_APP_API_URL}/fetch-all-complete-data`);
...
//   return (
//     <>
//       <h6 style={{ color: "#105EEB" }}>Recent Added PROPERTY</h6>
...
//                     <p className="card-title">{property.propertyMode}</p>
//                     <p className="card-text text-muted">
//                       <MdLocationOn /> {property.city}
//                     </p>
...
//                         <div className="col-md-6 col-6">
//                           <p>
//                             <FaBed className="icon ms-3" /> {property.bedrooms} Bhk
//                           </p>
//                         </div>
//                       </div>
//                       <div className="row">
//                         <div className="col-md-6 col-6">
//                           <p>
//                             <FaUserAlt className="icon" /> {property.ownership}
//                           </p>
//                         </div>
//                         <div className="col-md-6 col-6">
//                           <p>
//                             <FaCalendarAlt className="icon ms-3" /> {property.bestTimeToCall}
//                           </p>
//                         </div>
//                       </div>
//                     </div>
