...
//       </li>
//       <li className="nav-item">
//         <a className="nav-link" style={{ color: 'black' }} href="/" onClick={closeSidebar}>
//           <FaLightbulb className="me-2" style={{ color: '#30747F' }} /> My Plan
//         </a>
//       </li>
//       <li className="nav-item">
//         <a className="nav-link" style={{ color: 'black' }} href="/my-profile" onClick={closeSidebar}>
//           <FaUserCircle className="me-2" style={{ color: '#30747F' }} /> My Profile
//         </a>
//       </li>
//       <li className="nav-item">
//         <a className="nav-link" style={{ color: 'black' }} href="/plans" onClick={closeSidebar}>
...
//       </li>
//       <li className="nav-item">
//         <a className="nav-link" style={{ color: 'black' }} href="/about-mobile" onClick={closeSidebar}>
//           <FaInfoCircle className="me-2" style={{ color: '#30747F' }} /> About Us
//         </a>
//       </li>
//       <li className="nav-item">
//         <a className="nav-link" style={{ color: 'black' }} href="/refund-mobile" onClick={closeSidebar}>
...
//       </li>
//       <li className="nav-item">
//         <a className="nav-link" style={{ color: 'black' }} href="/business" onClick={closeSidebar}>
//           <FaShieldAlt className="me-2" style={{ color: '#30747F' }} /> Business Opportunity
//         </a>
//       </li>
//       <li className="nav-item">
//         <a className="nav-link" style={{ color: 'black' }} href="/our-support" onClick={closeSidebar}>
